...
class ArchiCategoryPage extends StatefulWidget {
  @override
  _ArchiCategoryPageState createState() => _ArchiCategoryPageState();
}

class _ArchiCategoryPageState extends State<ArchiCategoryPage> {
