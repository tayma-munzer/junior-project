...
const add_course_rating = URL + "add_course_rating"; //تقييم الكورسات
const add_job_rating = URL + "add_job_rating"; //تقييم العمل
const add_service_rating = URL + "add_service_rating"; //تقييم الخدمات
const add_training_courses_rating =
    URL + "add_training_courses_rating";//تقييم الدورات