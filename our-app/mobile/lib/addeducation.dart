...
class addeduction extends StatefulWidget {
  final int cv_id;
  const addeduction(this.cv_id, {Key? key}) : super(key: key);

  @override
  State<addeduction> createState() => _addeductionState();
}

class _addeductionState extends State<addeduction> {
