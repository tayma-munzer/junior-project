...
class GraphicsCategoryPage extends StatefulWidget {
  @override
  _GraphicsCategoryPageState createState() => _GraphicsCategoryPageState();
}

class _GraphicsCategoryPageState extends State<GraphicsCategoryPage> {
